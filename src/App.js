              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-white">
                    ¿Por qué lo denominamos “Mercurius”?
                  </h4>
                  <p className="text-md font-light mt-2 text-white">
                  A inicios de la creación del sistema de diseño se pensó en utilizar un nombre que hiciera referencia a un estilo de comunicación elocuente. “Mercurius” surgió de Mercurio,  conocido en la mitología romana como el Dios del comercio, la elocuencia, la velocidad y la comunicación. 
                  </p>
                </blockquote>
              </div>
            </div>
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Mercurius incluye una gama de colores que representan la marca Xtrim.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        También se cuenta con una guía de diseño que ayudará a crear desarrollos que mantengan la identidad de Xtrim.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Iconografía</h6>
                      <p className="mb-4 text-blueGray-500">
                        Variedad de íconos representativos de Xtrim.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Pesos, tamaños de letra, espaciado y demás.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                ...
                <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                  La documentación ayudará a mantener los lineamientos de la marca en todos los desarrollos.
                </p>
